...
export default function BlogCard({ title, excerpt, slug, date, category, readTime, image }: Props) {
  return (
    <motion.div
      ...
      whileHover={{ y: -6 }}
      className="group flex flex-col rounded-2xl border border-slate-200 bg-white shadow-sm hover:shadow-xl hover:shadow-blue-500/10 hover:border-blue-200 transition-all duration-300 overflow-hidden"
    >
      {image && (
