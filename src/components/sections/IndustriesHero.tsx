  ...
  return (
    <section className="relative py-32 bg-slate-950 text-white overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          className="absolute -top-32 -right-32 h-[500px] w-[500px] rounded-full bg-purple-600 opacity-15 blur-3xl"
          animate={{ x: [0, -60, 0], y: [0, 40, 0] }}
          transition={{ duration: 20, repeat: Infinity, ease: 'easeInOut' }}
        />
        <motion.div
          className="absolute -bottom-32 -left-32 h-[400px] w-[400px] rounded-full bg-cyan-500 opacity-10 blur-3xl"
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="mx-auto mt-6 max-w-2xl text-lg text-slate-400">
          SysPara delivers tailored AI, automation, and digital solutions built around the unique challenges and opportunities of your industry.
        </motion.p>
      </div>
    </section>
  );
