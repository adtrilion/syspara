    ...
    <section className="relative py-32 bg-slate-950 text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }} className="text-5xl font-bold leading-tight md:text-6xl">
          Contact <span className="gradient-text">SysPara</span>
        </motion.h1>
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="mx-auto mt-6 max-w-2xl text-lg text-slate-400">
          Let's discuss your project and explore how we can help your business with AI-powered solutions and digital transformation.
        </motion.p>
      </div>
    </section>
  );
