      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <AnimatedSection>
            ...
            <h2 className="text-4xl font-bold text-slate-900 mb-4">What Are AI Agents?</h2>
            ...
            <div className="space-y-4">
              {points.map((p) => (
                <div key={p.title} className="flex items-start gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 hover:border-blue-200 hover:bg-white transition-all duration-200">
                  <div className={`shrink-0 rounded-lg bg-gradient-to-br ${p.color} p-2 text-white`}>
                    {p.icon}
                  </div>
                  <div>
