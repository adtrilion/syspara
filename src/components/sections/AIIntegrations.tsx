    ...
    <section className="py-24 bg-slate-950">
      <div className="max-w-6xl mx-auto px-4">
        <AnimatedSection className="text-center mb-14">
          <span className="inline-block rounded-full bg-violet-900/30 border border-violet-500/30 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-violet-400 mb-4">
            Integrations
          </span>
          <h2 className="text-4xl font-bold text-white">AI Integration Services</h2>
